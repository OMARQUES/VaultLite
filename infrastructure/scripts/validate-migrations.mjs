...
function assertTables(database) {
  ...
  const expectedTables = [
    ...
    'audit_events',
    'auth_rate_limits',
    'automatic_icon_registry',
    'deployment_state',
    'extension_link_requests',
    'extension_pairings',
    'extension_session_recover_secrets',
    'icon_ingest_jobs',
    'icon_objects',
    'idempotency_records',
    'invites',
    'manual_site_icon_overrides',
    'password_generator_history',
    'realtime_one_time_tokens',
    'realtime_outbox',
    'session_policies',
    'sessions',
    'site_icon_cache',
    ...
    'unlock_grants',
    'user_accounts',
    'user_icon_item_domain_heads',
    'user_icon_item_domains',
    'user_icon_reindex_sessions',
    'user_icon_state',
    'user_icon_versions',
    'vault_folder_assignments',
    'vault_folders',
    'vault_form_metadata',
    'vault_item_history',
    'vault_item_tombstones',
    'vault_items',
    'web_bootstrap_grants',
  ];
